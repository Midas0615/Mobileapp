...
<footer id="contact" class="page-footer default_color scrollspy">
    <?php if (Yii::app()->controller->id == "home" && Yii::app()->controller->action->id == "index"): ?>
        <div class="container">  
            <div class="row">
                <div class="col l6 s12">
                    <form class="col s12" onsubmit="return false;" method="post">
                        <div class="row">
        ...
        <!--  Scripts-->
<!--        <script src="<?php echo Yii::app()->params->FRONT_BT_URL; ?>min/plugin-min.js"></script>        
        <script src="<?php echo Yii::app()->params->FRONT_BT_URL; ?>min/custom-min.js"></script>  -->
    <?php endif; ?>
