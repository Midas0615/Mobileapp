...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2017 at 07:30 PM
...
--
-- Table structure for table `mob_comments`
--

CREATE TABLE `mob_comments` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `mob_comments`
--
ALTER TABLE `mob_comments`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `mob_comments`
--
ALTER TABLE `mob_comments`
